...
<div class="container">
    <div class="wrapper">
        <canvas id="canvas" width="700" height="500" bind:this={canvas} style="border:1px solid black;background-color:white" on:contextmenu={onRClick} on:mousedown={onMouseDown} on:mouseup={onMouseUp} on:mousemove={onMouseMove} />
        <div class="all">
            <div class="colors">
                <div class="mains">
                    <div class="main">
            ...
            <input class="inp" on:change={(e)=>getLineWidth(e,line,crc2d)} type="range" value="1" step="1" min="1" max="10" name="" id="1"> <div class="tools"> {#each tools as tool }
